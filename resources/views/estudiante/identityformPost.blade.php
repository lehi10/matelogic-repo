...
<div class="container text-center">    
  <div class="row content">
    ...
    <h2>Identidad Cultural (Completar despues de jugar) </h2><hr>
            <p>Buenos días querido estudiante. Te pedimos que llenes este formulario una vez que hayas terminado de pasar todos los niveles del videojuego yachay.</p>
        ...
        <br><br>
            <form action="/saveSurveyPostform" method="POST">       
            @csrf     
            <div class="row">
                <div class="col-sm-8" > 
                <strong>
